  ...
  <div class="shop-view relative">
    ...
    <div class="shop-banner w-screen h-auto relative">
      <div class="mask w-screen h-auto">
        <img
          class="w-screen object-cover opacity-50"
          :src="shopInfo.photo_url"
          :alt="shopInfo.name"
          srcset
        />
      </div>
      <p
        class="absolute text-white w-full h-full top-0 flex justify-center items-center text-4xl fadeInUp"
      >{{ shopInfo.name }}</p>
    </div>
      ...
      <div class="mapouter">
        <div class="gmap_canvas">
          <iframe
            ...
            height="500"
            id="gmap_canvas"
            :src="'https://maps.google.com/maps?q=' + shopInfo.latitude + ',' + shopInfo.longitude + '&t=&z=17&ie=UTF8&iwloc=&output=embed'"
            frameborder="0"
            scrolling="no"
            marginheight
            marginwidth
